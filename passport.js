...
module.exports = function( http_servers, rs ) {
  ...
  var RS           = rs.RS
    ...
    , session_options = {
        key: 'rs_sid',
        secret: 'wolfgang-amadeus-mozart', // ToDo: get express-session secret from configuration
  ...
  rs
    .passport_strategies_configuration( passport_route, { filepath: '~/amadeus.rs.json' } )
